(function (global, factory) {
  ...
  function initGlobApi(Vue) {
    ...
    Vue.extend = function (options) {
      ...
      Sub.prototype = Object.create(Vue.prototype); // 将子组件中的this指向Sub

      Sub.prototype.constructor = Sub; // 将父组件中的属性合并

      Sub.options = mergeOptions(Vue.options, options); // console.log(spuer.options, options)
  ...
  function patchVnode(oldVnode, vnode) {
    ...
    if (!isSameVnode(oldVnode, vnode)) {
      ...
      /*新老节点相同*/
      var _el = vnode.el = oldVnode.el; // console.log(el)
      ...
      var newChildren = vnode.children || []; // console.log(oldVnode, vnode)
  ...
  function updateChildren(el, oldChildren, newChildren) {
    ...
    if (newStartIndex <= newEndIndex) {
      for (var i = newStartIndex; i <= newEndIndex; i++) {
        var childEl = createEl(newChildren[i]); // el.appendChild(childEl)
